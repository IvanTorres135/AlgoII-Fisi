...
import pe.unmsm.agenda.controller.*;
import pe.unmsm.agenda.model.Contrato;

public class Agenda extends JFrame {
    private static final long serialVersionUID = 1L;
    private static final String ICONE_ADICIONA = "/toolbarButtonGraphics/general/Add16.png";
    private static final String ICONE_REMOVE = "/toolbarButtonGraphics/general/Delete16.png";
    
    private final DefaultListModel<Contrato> contatos = new DefaultListModel<>();
    private final JList<Contrato> listaContatos = new JList<>(contatos);
    ...
    private void montaJanela() {        
        ...
        painelLista.setBorder(BorderFactory.createTitledBorder("Contratos"));
        ...
        // Criando um painel com os botÃµes sob a lista
        ...
        painelNome.add(new JLabel("Nombre: "), BorderLayout.WEST); 
        ...
        painelTelefone.add(new JLabel("Telefono: "), BorderLayout.WEST);
        ...
        painelDetalhes.setBorder(BorderFactory.createTitledBorder("Detalles"));
        campoDetalhes.setEnabled(false);
        painelDetalhes.add(new JScrollPane(campoDetalhes), BorderLayout.CENTER);

        // Criando um painel central que combina os campos de texto, a Ã¡rea de texto e os botÃµes
